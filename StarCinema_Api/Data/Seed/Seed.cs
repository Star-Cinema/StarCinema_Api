        ...
        {     
            ...
            List<User> users = new List<User>()
            {
                new User() { Email="admin@gmail.com", PasswordSalt = passwordSalt, PasswordHash=passwordHash,
                    ...
                    IsDelete=false, RoleId=1, Gender=true, IsEmailVerified=true, Avatar = "https://www.google.com/url?sa=i&url=https%3A%2F%2Fheadenglish.edu.vn%2Favatar-admin%2F&psig=AOvVaw2GdWD3MioCpgS5VD6WYAMr&ust=1685768203927000&source=images&cd=vfe&ved=0CBEQjRxqFwoTCMjpqYrmo_8CFQAAAAAdAAAAABAE"},
