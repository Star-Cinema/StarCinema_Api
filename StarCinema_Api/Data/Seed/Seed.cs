        ...
        {     
            ...
            List<User> users = new List<User>()
            {
                new User() { Email="admin@gmail.com", PasswordSalt = passwordSalt, PasswordHash=passwordHash,
                    ...
                    IsDelete=false, RoleId=1, Token=verifyCode,Gender=true, IsEmailVerified=true, Avatar = "https://www.google.com/url?sa=i&url=https%3A%2F%2Fheadenglish.edu.vn%2Favatar-admin%2F&psig=AOvVaw2GdWD3MioCpgS5VD6WYAMr&ust=1685768203927000&source=images&cd=vfe&ved=0CBEQjRxqFwoTCMjpqYrmo_8CFQAAAAAdAAAAABAE"},
                new User() { Email="user01@gmail.com", PasswordSalt = passwordSalt, PasswordHash=passwordHash,
                    ...
                    IsDelete=false, RoleId=2, Token=verifyCode, Gender=true, IsEmailVerified=false, Avatar = "https://upload.wikimedia.org/wikipedia/commons/thumb/5/59/User-avatar.svg/2048px-User-avatar.svg.png"  },
                ...
                new User() { Email="hungklyhongkl@gmail.com", PasswordSalt = passwordSalt, PasswordHash=passwordHash,
                    Name = "Trần Đức Hùng", Token=verifyCode, Phone="0326614248", Dob= new DateTime(2001,07,26,00,00,00),
                    IsDelete=false, RoleId=2, Gender=true, IsEmailVerified=false, Avatar = "https://upload.wikimedia.org/wikipedia/commons/thumb/5/59/User-avatar.svg/2048px-User-avatar.svg.png"  },
            };
